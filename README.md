...
2. Go to [data_collection](/data_collection), run function [split](/data_collection/map_remap.py#L144) to extract comments from the code snippets in [code snippets-without-labels](/code%20snippets-without-labels). 
