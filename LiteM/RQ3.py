...
SATDID_result = '../SATDID/results/within_project.txt'
TEDIOUS_result = '../TEDIOUS/results/within_project.txt'
LiteM_result = 'results/within_project_ASMOTE_LightGBM.txt'
DT_result = 'results/within_project_ASMOTE_DecisionTree.txt'
...
for i in range(len(LiteM_lines)):
    ...
    data = [LiteM_datum, DT_datum, TEDIOUS_datum, SATDID_datum]
